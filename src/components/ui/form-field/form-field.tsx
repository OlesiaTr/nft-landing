    ...
    <div className="flex flex-col items-end">
      ...
      <div className="flex w-full items-center rounded-lg bg-black backdrop-blur-[6px]">
        ...
        <input
          ...
          {...register(name)}
          className={clsx(
            'flex w-full items-center rounded-l-none rounded-r-lg border border-black bg-darkBg px-6 py-4 text-xs uppercase leading-[1.16] outline-none transition placeholder:text-placeholder hover:border hover:border-white hover:text-white focus:border focus:border-white focus:text-white active:border active:border-white active:text-white xl:py-[22px] xl:text-base xl:leading-[1.18]',
